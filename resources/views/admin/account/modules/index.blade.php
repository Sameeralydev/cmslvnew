...
@section('content')
    ...
    @if (($moduleKey ?? '') === 'documents' || request()->is('admin/account/documents*'))
        <style>
            .doc-page-container {
                        ...
                        <div class="overflow-x-auto">
                            <table class="doc-table" id="docsTable">
                                ...
                                <tbody>
                                    @php
                                        $sampleDocs = [
                                            ['title' => 'POLICY MANUAL ACCOUNTS', 'type' => 'Policy Manual'],
                                            ['title' => 'FLOW CHARTS ACCOUNTS', 'type' => 'Flow Charts'],
                                            ['title' => 'FEE COLLECTION POLICY', 'type' => 'Supportive Documents'],
                                            ['title' => 'EXPENSE VOUCHER TEMPLATE', 'type' => 'Supportive Documents'],
                                            ['title' => 'BANK RECONCILIATION FORMAT', 'type' => 'Supportive Documents'],
                                            ['title' => 'PURCHASE ORDER TEMPLATE', 'type' => 'Supportive Documents'],
                                            ['title' => 'CHART OF ACCOUNTS STRUCTURE', 'type' => 'Supportive Documents'],
                                            ['title' => 'PETTY CASH REGISTER', 'type' => 'Registers'],
                                        ];
                                    @endphp
