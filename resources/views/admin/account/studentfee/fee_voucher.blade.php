        ...
        <form id="feevoucherForm" action="{{ url('admin/account/studentfee/assignfeevoucher/' . $brc_id) }}" method="POST">
            ...
            <div class="box-body">
                ...
                <div class="grid-2-col">
                    ...
                    <div class="form-group">
                        <label for="session_id">Academic Session <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                ...
                <div class="grid-2-col" id="classSectionRow" style="display: none;">
                    <div class="form-group" id="classCol">
                        <label for="class_id">Class <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                    ...
                    <div class="form-group" id="sectionCol" style="display: none;">
                        <label for="section_id">Section <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                ...
                <div class="grid-2-col">
                    <div class="form-group">
                        <label for="fees_month">Fee Month <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                        <input type="text" id="fees_month" name="fees_month" class="form-control-cmsc" value="{{ $fees_month ?: date('d/m/Y') }}" required>
                    </div>
                    <div></div>
                </div>
            </div>
