            ...
            <form id="datewiseForm" action="{{ url('admin/account/studentfee/assignfeevoucherdatewise/' . $brc_id) }}" method="POST">
                ...
                <div class="box-body">
                    ...
                    <div class="grid-2-col">
                        <div class="form-group">
                            <label for="brc_id">Branch <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                        ...
                        <div class="form-group">
                            <label for="student_id">Admission No <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                    ...
                    <div class="grid-2-col">
                        <div class="form-group">
                            <label for="from_month">From Month <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                            <input type="text" id="from_month" name="from_month" class="form-control-cmsc" value="{{ $from_month ?: date('d/m/Y') }}" onchange="calculateTotalFee()" required>
                        </div>

                        <div class="form-group">
                            <label for="to_month">To Month <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                            <input type="text" id="to_month" name="to_month" class="form-control-cmsc" value="{{ $to_month ?: date('d/m/Y') }}" onchange="calculateTotalFee()" required>
                        </div>
                    </div>
                    ...
                    <div class="grid-2-col">
                        <div class="form-group">
                            ...
                            <input type="text" id="issue_date" name="issue_date" class="form-control-cmsc" value="{{ $issue_date ?: date('d/m/Y') }}" required>
                        </div>

                        <div class="form-group">
                            <label for="due_date">Due Date <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                            <input type="text" id="due_date" name="due_date" class="form-control-cmsc" value="{{ $due_date ?: date('d/m/Y') }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-footer">
                    ...
                    <div style="display: flex; align-items: center; gap: 15px;">
                        <label style="font-weight: 400; cursor: pointer; display: inline-flex; align-items: center; gap: 5px;">
