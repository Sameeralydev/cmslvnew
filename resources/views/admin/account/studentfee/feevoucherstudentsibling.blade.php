                ...
                <form id="studentWiseForm" action="{{ url('admin/account/studentfee/feevoucherstudentsibling/' . $brc_id . '/1') }}" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <div class="grid-2-col">
                            <div class="form-group">
                                <label for="brc_id_std">Branch <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                        ...
                        <div class="grid-2-col">
                            <div class="form-group">
                                <label for="issue_date_std">Issue Date <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                                <input type="text" id="issue_date_std" name="issue_date" class="form-control-cmsc" value="{{ old('issue_date', $issue_date) }}" required>
                            </div>

                            <div class="form-group">
                                <label for="due_date_std">Due Date <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                    ...
                    <div class="box-footer">
                        <div class="total-fee-label">
                            Total Fee:- <span id="total_student_fee_display">{{ !empty($totalfee) ? number_format($totalfee, 0, '.', ',') : '' }}</span>
                        </div>
            ...
            <div class="box">
                ...
                <form id="siblingWiseForm" action="{{ url('admin/account/studentfee/feevoucherstudentsibling/' . $brc_id . '/2') }}" method="POST">
                    ...
                    <div class="box-body">
                        ...
                        <div class="grid-2-col">
                            <div class="form-group">
                                <label for="brc_id_sib">Branch <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                            ...
                            <div class="form-group">
                                <label for="sibling_id">Sibling Code <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                        ...
                        <div class="grid-2-col">
                            <div class="form-group">
                                <label for="issue_date_sib">Issue Date <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                                <input type="text" id="issue_date_sib" name="issue_date" class="form-control-cmsc" value="{{ old('issue_date', $issue_date) }}" required>
                            </div>

                            <div class="form-group">
                                <label for="due_date_sib">Due Date <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                    ...
                    <div class="box-footer">
                        <div class="total-fee-label">
                            Total Fee:- <span id="total_sibling_fee_display">{{ !empty($siblingtotalfee) ? number_format($siblingtotalfee, 0, '.', ',') : '' }}</span>
                        </div>
