...
<div class="customfeevoucher-page-container">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Custom Fee Voucher</h3>
        </div>
        ...
        <form id="customfeevoucherForm" action="{{ url('admin/account/studentfee/customfeevoucher/' . $brc_id) }}" method="POST">
            ...
            <div class="box-body">
                ...
                <div class="grid-4-col">
                    ...
                    <div class="form-group">
                        <label for="feetype_id">Fee Type <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                ...
                <div class="grid-4-col">
                    <div class="form-group">
                        ...
                        <input type="text" id="issue_date" name="issue_date" class="form-control-cmsc" value="{{ old('issue_date', $issue_date ?: date('d/m/Y')) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="due_date">Due Date <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                        <input type="text" id="due_date" name="due_date" class="form-control-cmsc" value="{{ old('due_date', $due_date ?: date('d/m/Y')) }}" required>
                    </div>

                    <div class="form-group">
                        <label for="search_type">Search Type <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
