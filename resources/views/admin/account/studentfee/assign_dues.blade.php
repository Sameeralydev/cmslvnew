...
<style>
    ...
    .form-control-cmsc:focus {
        border-color: #3368bf;
        outline: 0;
        box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 6px rgba(51,104,191,.4);
    }
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="brc_wise">Branch Wise <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                ...
                {{-- Classes Wise --}}
                <div class="form-group">
                    <label for="classes_wise">Classes Wise <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                ...
                {{-- Sections Wise --}}
                <div class="form-group">
                    <label for="sections_wise">Sections Wise <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                ...
                {{-- Students Wise --}}
                <div class="form-group">
                    <label>Students Wise <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                    <div>
            ...
            <div class="box-body" id="proceedBody" style="min-height: 250px;">
                <div id="studentCriteriaSection" style="display: none; margin-bottom: 15px;">
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px; margin-bottom: 10px;">
                        <div>
                            <label style="font-size: 11px; font-weight: 400;">Branch <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                        ...
                        <div>
                            <label style="font-size: 11px; font-weight: 400;">Class <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                        ...
                        <div>
                            <label style="font-size: 11px; font-weight: 400;">Section <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                    ...
                    <div>
                        <label style="font-size: 11px; font-weight: 400;">Admission No (comma separated)</label>
            ...
            <form id="addDuesForm">
                ...
                <div class="box-body">
                    <div id="duesRowsContainer">
                        ...
                        <div class="dues-row-grid">
                            <div class="form-group" style="margin-bottom: 0;">
                                <label style="font-size: 12px;">Dues Type <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                            ...
                            <div class="form-group" style="margin-bottom: 0;">
                                <label style="font-size: 12px;">School Amount(Rs.) <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                                <input type="number" step="any" min="0" name="school_amount[]" class="form-control-cmsc" required>
                            </div>
                            <div class="form-group" style="margin-bottom: 0;">
                                <label style="font-size: 12px;">Amount(Rs.) <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                    ...
                    <div style="margin-top: 15px;">
                        <div class="form-group">
                            <label for="issue_date">Issue Date <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                            <input type="text" id="issue_date" name="issue_date" class="form-control-cmsc" value="{{ date('d/m/Y') }}" required>
                        </div>
                        <div class="form-group">
                            <label for="due_date">Due Date <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                            <input type="text" id="due_date" name="due_date" class="form-control-cmsc" value="{{ date('d/m/Y') }}" required>
                        </div>
                        <div class="form-group">
                            <label for="dues_date">Assign Dues Date <small class="req" style="color: #ff0000; font-weight: normal;">*</small></label>
                            <input type="text" id="dues_date" name="dues_date" class="form-control-cmsc" value="{{ date('d/m/Y') }}" required>
                        </div>
                        <div class="form-group">
        ...
        .then(function(data) {
            if (data.status === 'success') {
                if (window.showToastMessage) {
                    window.showToastMessage('Record Saved Successfully');
