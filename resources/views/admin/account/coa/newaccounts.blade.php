                        ...
                        <form id="form1" action="{{ $editAccount ? route('admin.account.accounts.newaccountsupdate', $editAccount->id, absolute: false) : route('admin.account.accounts.newaccountscreate', absolute: false) }}" method="POST" accept-charset="utf-8">
                            ...
                            <div class="box-body" style="padding: 15px;">
                                ...
                                <div class="form-group" style="margin-bottom: 15px;">
                                    <label for="accounts_type_id" style="font-weight: 400; font-size: 13px; color: #333; display: block; margin-bottom: 5px;">
                                        Accounts Head <small class="req" style="color: #ff0000; font-weight: normal;">*</small>
                                    </label>
                                ...
                                <div class="form-group" style="margin-bottom: 15px;">
                                    <label for="name" style="font-weight: 400; font-size: 13px; color: #333; display: block; margin-bottom: 5px;">
                                        Account Type Name <small class="req" style="color: #ff0000; font-weight: normal;">*</small>
                                    </label>
                            ...
                            <table class="table table-striped table-bordered table-hover example">
                                    <thead>
                                        <tr style="background-color: #1e3a8a; color: #ffffff;">
                                            ...
                                            <th class="text-right noExport" style="text-align: right; width: 60px; padding: 8px 12px; border: 1px solid #162c6d; color: #fff; font-weight: 500;">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
