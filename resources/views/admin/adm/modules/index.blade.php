...
@section('content')
    ...
    @if (($moduleKey ?? '') === 'documents' || request()->is('admin/adm/documents*') || request()->is('admin/hrms/documents*') || request()->is('admin/academics/documents*') || request()->is('admin/account/documents*'))
        <style>
            .doc-page-container {
            ...
            /* Toolbar matching CodeIgniter DataTables */
            .doc-toolbar {
                display: flex;
                align-items: center;
                        ...
                        <div class="overflow-x-auto">
                            <table class="doc-table" id="docsTable">
                                ...
                                <tbody>
                                    @php
                                        $sampleDocs = [
                                            ['title' => 'POLICY MANUAL ADMINISTRATION', 'type' => 'Policy Manual'],
                                            ['title' => 'FLOW CHARTS ADMINISTRATION', 'type' => 'Flow Charts'],
                                            ['title' => 'BACK TAGS ADMINISTRATION', 'type' => 'Supportive Documents'],
                                            ['title' => 'FOLDER COVER PAGES ADMINISTRATION', 'type' => 'Supportive Documents'],
                                            ['title' => 'FOLDER INDEX PAGES ADMINISTRATION', 'type' => 'Supportive Documents'],
                                            ['title' => 'ADMISSION TEST FOR PRE YEAR 2', 'type' => 'Supportive Documents'],
                                            ['title' => 'ADMISSION TEST FOR PRE YEAR 3', 'type' => 'Supportive Documents'],
                                            ['title' => 'ADMISSION TEST FOR GRADE 1', 'type' => 'Supportive Documents'],
                                            ['title' => 'ADMISSION TEST FOR GRADE 2', 'type' => 'Supportive Documents'],
                                            ['title' => 'ADMISSION TEST FOR GRADE 3', 'type' => 'Supportive Documents'],
                                            ['title' => 'ADMISSION TEST FOR GRADE 4', 'type' => 'Supportive Documents'],
                                        ];
                                    @endphp
